...
inline static T constexpr sigmoid_erf(T value) noexcept {
  ...
  //return static_cast<T>(0.5) + (static_cast<T>(0.5) * boost::math::erf((value * static_cast<T>(4)) - static_cast<T>(2)));
  ...
  T const scale = static_cast<T>(0.5) / boost::math::erf(static_cast<T>(2));
  return static_cast<T>(0.5) + (scale * boost::math::erf((value * static_cast<T>(4)) - static_cast<T>(2)));
};
