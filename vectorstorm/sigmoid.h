...
inline static T constexpr sigmoid_sin(T value) noexcept {
  ...
  T constexpr const half = static_cast<T>(0.5);
...
inline static T constexpr sigmoid_tanh(T value) noexcept {
  ...
  T constexpr const scale = half / std::tanh(static_cast<T>(2));
...
inline static T constexpr sigmoid_log(T value) noexcept {
  ...
  T constexpr const scale = static_cast<T>(1) / (static_cast<T>(1) / (static_cast<T>(1) + std::exp(static_cast<T>(-4))) - half);
