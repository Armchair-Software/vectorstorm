...
template<typename T>
inline static T constexpr sigmoid_sin(T value) __attribute__((__always_inline__));
template<typename T>
inline static T constexpr sigmoid_sin(T value) {
...
template<typename T>
inline static T constexpr sigmoid_tanh(T value) __attribute__((__always_inline__));
template<typename T>
inline static T constexpr sigmoid_tanh(T value) {
...
template<typename T>
inline static T constexpr sigmoid_log(T value) __attribute__((__always_inline__));
template<typename T>
inline static T constexpr sigmoid_log(T value) {
