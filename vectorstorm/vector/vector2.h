...
public:
   ...
   * @return length of vector
   */
  [[deprecated("Use length<vector2<T>::sqrt_mode::fast>()")]]
   ...
   * @return length of vector
   */
  [[deprecated("Use length<vector2<T>::sqrt_mode::coarse>()")]]
  ...
  [[deprecated("Use normalise_copy<vector2<T>::sqrt_mode::coarse>()")]]
