...
template<typename T>
inline static T constexpr deg2rad(T const angle_deg) noexcept __attribute__((__always_inline__));
template<typename T>
inline static T constexpr deg2rad(T const angle_deg) noexcept {
