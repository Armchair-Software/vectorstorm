...
- `matrix4<T> create_translation(T x, T y, T z, T w = 1)` Creates a translation matrix from x, y, and z direction translation values, and an optional w translation.  Overloads accept vector3 and vector4.
